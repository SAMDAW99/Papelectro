...
urlpatterns = [
    ...
    path('registro/', RegisterAndCreateEmpresaView.as_view(), name='register_and_create_empresa'),
    path('registro_basico/', RegisterAndCreateEmpresaViewBasico.as_view(), name='register_and_create_empresa_basico'),
